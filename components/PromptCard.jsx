  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between items-center gap-5">
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer" onClick={()=>router.push(`/user-profile/${post.creator._id}`)}>
        ...
        <div className="copy_btn" onClick={handleCopy}>
          <Image src={coppied === '' ? '/assets/icons/copy.svg' : '/assets/icons/tick.svg'} width={12} height={12}/>
        </div>
      </div>
